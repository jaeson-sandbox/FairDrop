...
| 3 — Run reliably on supported desktops | Twelve stories covering native CI/releases, lifecycle and platform hardening, error/event handling, and verification evidence | Stories 3.1–3.7 done; 3.8 in progress, folder-safety checkpoint |
